...
* 		dependent variable  
* 		Only 22 observations of relationships forming when still in initial 
* 		education spell. 
xtset idperson swv
fre dcpen if (dag >= 18 & ded == 1 & ssscp != 1) 

/*
probit dcpen i.dgn dag dagsq li.ydses_c5 l.dnc dhe i.drgn1 stm ///
	if (dag >= 18 & ded == 1 & ssscp != 1) [pweight = dimxwt], vce(robust)
*/

probit dcpen i.Dgn Dag Dag_sq li.Ydses_c5_Q2 li.Ydses_c5_Q3 ///
	li.Ydses_c5_Q4 li.Ydses_c5_Q5 l.Dnc Dhe ///
...
probit dcpen Dag Dag_sq i.Deh_c3_Medium i.Deh_c3_Low i.Dgn ///
	...
	$regions Year_transformed Y2020 Y2021 Y2022 if ///
...
probit dcpex Dag Dag_sq li.Deh_c3_Medium li.Deh_c3_Low ///
	...
	l.Ypnbihs_dv l.Ynbcpdf_dv $regions Year_transformed ///
	Y2020 Y2021 Y2022 if ///
	(dgn == 0 & dag >= 18 & ded == 0 & ssscp != 1) [pweight = dimxwt], ///
	vce(robust)		
