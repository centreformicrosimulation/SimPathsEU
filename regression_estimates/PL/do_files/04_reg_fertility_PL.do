...
putexcel A5 = "F1a"
putexcel B5 = "Probit regression estimates of the probability of  having a child for women aged 18-30 in initial education spell"
putexcel A6 = "F1b"
putexcel B6 = "Probit regression estimates of probability of having a child for women aged 18-49 not in initial education spell"
...
tab dchpd if (sprfm == 1 & ded == 1 & dag < 30 & dgn == 0) 
...
probit dchpd Dag Dhe i.Dcpst_Single if ///
	sprfm == 1 & ded == 1 & dgn == 0 [pweight = dimxwt], vce(robust)
...
* DV:	New born child dummy 
xtset idperson swv
tab dchpd if (sprfm == 1 & ded == 0 & dgn == 0) 
...
probit dchpd Dag Dag_sq li.Ydses_c5_Q2 li.Ydses_c5_Q3 ///
	...
	li.Les_c3_NotEmployed $regions Year_transformed ///
	Y2020 Y2021 if ///
	(sprfm == 1 & ded == 0 & dgn == 0) [pweight = dimxwt], vce(robust)
