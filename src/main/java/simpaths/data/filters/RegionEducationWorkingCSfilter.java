...
public class RegionEducationWorkingCSfilter implements ICollectionFilter{
	...
	public boolean isFiltered(Object object) {
		if(object instanceof Person) {
			...
			return (person.getRegion().equals(region) && person.getDeh_c4().equals(education) && person.getLes_c4().equals(Les_c4.EmployedOrSelfEmployed) && person.getGrossEarningsYearly() >= 0.);
		}
