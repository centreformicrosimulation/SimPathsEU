...
*                  - Computes the share of retired persons (les_c4 == 4)
...
foreach y of numlist $min_year/$max_year {
	...
	* Build file name for the given year and import initial population data
	...
	// Alignment target: share of retired persons among those with non-missing les_c4
	gen byte isRetired = (les_c4 == 4)
    collapse (mean) retired_share = isRetired if (les_c4 != .) [pw = dwt]
