...
* Set Excel file 
* Info sheet
putexcel set "$dir_work/reg_partnership_HU", sheet("Info") replace
...
putexcel A7 = "U2b"
putexcel B7 = "Probit regression estimates of probabiliyt of exiting a partnership - cohabiting women aged 18+ not in initial education spell"

putexcel A10 = "Notes:", bold
putexcel B10 = "U1a doesn't include number of children under the age of 2 as a convariate and lagged health status is included as a continuous variable"
putexcel B11 = "In U1a cannot obtain estimates of the 5th quintile of hh income"
putexcel B12 = "U2b contains a new variable New_rel_L1"
	
putexcel set "$dir_work/reg_partnership_HU", sheet("Gof") modify
...
* 			dependent variable  
* 		Only 11 observation of relationships forming when still in initial 
* 			education spell. 
 
fre dcpen if (dag >= 18 & ded == 1 & ssscp != 1) 
fre dcpen if (dag >= 16 & ded == 1 & ssscp != 1) 

probit dcpen i.dgn dag dagsq li.ydses_c5 l.dnc dhe i.drgn1 stm y2021 ///
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_partnership_HU", sheet("U1a") modify
...
local var_list Dgn Dag Dag_sq Ydses_c5_Q2_L1 Ydses_c5_Q3_L1 Ydses_c5_Q4_L1 Dhe HUA ///
	HUB Year_transformed Y2021 Constant
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_partnership_HU", sheet("U1b") modify
putexcel C2 = matrix(var)
...
local var_list Dag Dag_sq Deh_c3_Medium Deh_c3_Low Dgn Les_c4_Student_L1 ///
	...
	Dhe_Good Dhe_VeryGood Dhe_Excellent HUA HUB Year_transformed ///
...
probit dcpex dag dagsq lib1.deh_c3 lib1.dehsp_c3 li.dhe li.dhesp ///
	...
	l.ypnbihs_dv l.ynbcpdf_dv i.drgn1 stm y2020 y2021 if ///
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_partnership_HU", sheet("U2b") modify
putexcel C2 = matrix(var)
...
local var_list Dag Dag_sq Deh_c3_Medium_L1 Deh_c3_Low_L1 Dehsp_c3_Medium_L1 ///
	...
	Lesdf_c4_BothNotEmployed_L1 Ypnbihs_dv_L1 Ynbcpdf_dv_L1 HUA HUB ///
