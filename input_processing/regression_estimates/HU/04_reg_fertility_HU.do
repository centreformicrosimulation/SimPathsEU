...
import excel "$dir_external_data/HU_fert_rate", sheet("f_rate") firstrow clear 

rename Year swv

label var dhufr "Fertility_rate"
...
* Set Excel file 
* Info sheet
putexcel set "$dir_work/reg_fertility_HU", sheet("Info") replace
...
putexcel B10 = "Very few individuals have children when in initial education spell, therefore have to take away many covariates to obtain estimate - consider removing process???"

putexcel set "$dir_work/reg_fertility_HU", sheet("Gof") modify
...
// only 34 ppl meet the condition 
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_fertility_HU", sheet("F1a") modify
...
probit dchpd dag dagsq li.ydses_c5 l.dnc l.dnc02 ib1.dhe ib1.dcpst ///
	lib1.dcpst ib1.deh_c3 dhufr li.les_c3 i.drgn1 stm y2020 y2021 if ///
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_fertility_HU", sheet("F1b") modify
putexcel C2 = matrix(var)
...
local var_list  Dag Dag_sq Ydses_c5_Q2_L1 Ydses_c5_Q3_L1 Ydses_c5_Q4_L1 ///
	...
	Les_c3_Student_L1 Les_c3_NotEmployed_L1 HUA HUB ///
