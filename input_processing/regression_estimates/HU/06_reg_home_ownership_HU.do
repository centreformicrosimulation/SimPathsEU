...
recode dhh_owned dgn dag dagsq les_c3 deh_c3 dhe yptciihs_dv ydses_c5 drgn1 ///
	dhhtp_c4 dhhtp_c8 lessp_c3 stm les_c4 (-9=.)
...
putexcel set "$dir_work/reg_home_ownership_HU", sheet("Info") replace
...
putexcel set "$dir_work/reg_home_ownership_HU", sheet("Gof") modify
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_home_ownership_HU", sheet("HO1a") modify 
...
local var_list Dgn Dag Dag_sq Dhhtp_c8_2_L1 Dhhtp_c8_3_L1 Dhhtp_c8_4_L1 ///
	...
	Ydses_c5_Q4_L1 Ydses_c5_Q5_L1 Yptciihs_dv_L1 Dhh_owned_L1 HUA HUB  ///
