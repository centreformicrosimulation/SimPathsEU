...
* Set Excel file 
* Info sheet
putexcel set "$dir_work/reg_retirement_HU", sheet("Info") replace
...
putexcel set "$dir_work/reg_retirement_HU", sheet("Gof") modify
...
probit drtren i.dgn dag dagsq i.dagpns_y i.dagpns_y1 ib1.deh_c3 i.dagpns ///
	li.lesnr_c2 li.ydses_c5 li.dlltsd i.drgn1 stm y2020 y2021 ///
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_retirement_HU", sheet("R1a") modify
...
local var_list Dgn Dag Dag_sq Elig_pen Elig_pen_L1 Deh_c3_Medium Deh_c3_Low ///
	...
	Ydses_c5_Q3_L1 Ydses_c5_Q4_L1 Ydses_c5_Q5_L1 Dlltsd_L1 HUA HUB ///
...
probit drtren i.dgn dag dagsq i.dagpns_y i.dagpns_y1 ib1.deh_c3 i.dagpns ///
	li.lesnr_c2 i.dagpns#li.lesnr_c2 li.ydses_c5 li.dlltsd i.dagpns_sp ///
	i.dagpns_y_sp i.dagpns_y1_sp  li.lessp_c3 li.dlltsd_sp i.drgn1 stm y2020 ///
	y2021 if (ssscp != 1 & dcpst == 1 & dag >= 50) [pweight = dimxwt], ///
	vce(robust)
...
mkmat v*, matrix(var)	
putexcel set "$dir_work/reg_retirement_HU", sheet("R1b") modify
putexcel C2 = matrix(var)
...
local var_list Dgn Dag Dag_sq Elig_pen Elig_pen_L1 Deh_c3_Medium ///
	...
	Dlltsdsp_L1 HUA HUB Year_transformed Y2020 Y2021 Constant
