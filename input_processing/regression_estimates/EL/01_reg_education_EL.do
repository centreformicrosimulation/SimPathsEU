...
probit ded i.Dgn Dag Dag_sq i.EL4 i.EL7 Y2012-Y2021 Y2022_2023 if ///
	(dag >= 16 & dag <= 29 & l.ded == 1) [pweight = dimxwt], vce(robust)	
...
probit der i.Dgn Dag Dag_sq li.Deh_c3_High li.Deh_c3_Low ///
	li.Les_c3_Student li.Les_c3_NotEmployed l.Dnc l.Dnc02 ///
	 ...
	 (dag >= 16 & dag <= 35 & ded == 0) [pweight=dimlwt], vce(robust)
...
* 				education  
* Sample: Those 16-29 who have just left their initial education spell in current 
* 			year 
...
gologit2 deh_c3_recoded i.Dgn Dag Dag_sq  ///
	i.EL4 i.EL7 Y2012-Y2021 Y2022_2023  ///
	  if Dag >= 16 & Dag <= 29 & l.ded == 1 & ded == 0  ///
	[pweight = dimxwt], autofit 	
