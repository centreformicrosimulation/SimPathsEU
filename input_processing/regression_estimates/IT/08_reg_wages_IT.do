...
import excel "$dir_external_data/${country}_Wages.xlsx", sheet("Wages") firstrow clear 
...
gen CPI = .
replace CPI = 92.6  if stm == 10
replace CPI = 95.3  if stm == 11
replace CPI = 98.4  if stm == 12
replace CPI = 99.7  if stm == 13
replace CPI = 99.9  if stm == 14
replace CPI = 100   if stm == 15
replace CPI = 99.9  if stm == 16
replace CPI = 101.3 if stm == 17
replace CPI = 102.5 if stm == 18
replace CPI = 103.2 if stm == 19
replace CPI = 103.0 if stm == 20
replace CPI = 105.0 if stm == 21
replace CPI = 114.2 if stm == 22
replace CPI = 120.9 if stm == 23
...
replace wage_hour = . if wage_hour >= 61.935 // UPDATE
...
local var_list Dag Dag_sq Deh_c3_Medium Deh_c3_Low Deh_c3_Medium_Dag ///
	...
	ITF ITG ITH ITI Pt RealWageGrowth Y2020 Y2021 Constant InverseMillsRatio
...
local var_list Les_c3_NotEmployed_L1 Dag Dag_sq ///
	...
	Dhe_VeryGood Dhe_Excellent ITF ITG ITH ITI Y2020 Y2021 ///
	Constant	
...
local var_list L1_log_hourly_wage Dag Dag_sq Deh_c3_Medium Deh_c3_Low ///
	...
	Dhe_Excellent ITF ITG ITH ITI Pt RealWageGrowth Y2020 Y2021 Constant ///
	InverseMillsRatio
