...
* Set Excel file 
* Info sheet
putexcel set "$dir_work/reg_leave_parental_home_${country}", sheet("Info") replace
...
* AB: Added not partnered condition as well to be consistent with the simulation
xtset idperson swv		
...
Ydses_c5_Q5_L1 ITF ITG ITH ITI Year_transformed Y2020 Constant
