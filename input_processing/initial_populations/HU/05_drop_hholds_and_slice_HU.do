...
drop if dropHH == 1 /*(58,955 observations deleted)*/

drop dropObs dropHH 
	
* Drop if hh weight = 0:
count if dwt == 0 
drop if dwt == 0 /*(18,600 observations deleted)*/
...
one year. Adjust here. This is not a general fix and shoudl be updated for 
different countries. 
*/
...
********************************************************************************
/*
Total population figures for Hungary from 2011 to 2023:
https://ec.europa.eu/eurostat/databrowser/view/demo_pjan/default/...
	table?lang=en&category=demo.demo_pop
*/
cap gen hu_pop = 0  
replace hu_pop = 9979000 if stm == 2011 
replace hu_pop = 9902000 if stm == 2012
replace hu_pop = 9870000 if stm == 2013
replace hu_pop = 9855000 if stm == 2014
replace hu_pop = 9853000 if stm == 2015
replace hu_pop = 9844000 if stm == 2016
replace hu_pop = 9811000 if stm == 2017 
replace hu_pop = 9769000 if stm == 2018
replace hu_pop = 9746000 if stm == 2019
replace hu_pop = 9689000 if stm == 2020
replace hu_pop = 9640000 if stm == 2021
replace hu_pop = 9610000 if stm == 2022
replace hu_pop = 9600000 if stm == 2023
...
cap drop  multiplier
gen multiplier = hu_pop / surv_pop 
