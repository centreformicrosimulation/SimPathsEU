********************************************************************************
* PROJECT:              ESPON
* DO-FILE NAME:         05_drop_hhold_an_slice_IT.do
...
********************************************************************************
/*
Total population figures for Italy from 2011 to 2023:
https://ec.europa.eu/eurostat/databrowser/view/demo_pjan/default/...
	table?lang=en&category=demo.demo_pop
*/
cap gen it_pop = 0 
replace it_pop = 60026841 if stm == 2011 
replace it_pop = 60191247 if stm == 2012
replace it_pop = 60311613 if stm == 2013
replace it_pop = 60320707 if stm == 2014
replace it_pop = 60229605 if stm == 2015
replace it_pop = 60115223 if stm == 2016
replace it_pop = 60002252 if stm == 2017 
replace it_pop = 60148658 if stm == 2018
replace it_pop = 59729081 if stm == 2019
replace it_pop = 59438851 if stm == 2020
replace it_pop = 59133173 if stm == 2021
replace it_pop = 59013667 if stm == 2022
replace it_pop = 58984216 if stm == 2023
...
cap drop  multiplier
gen multiplier = it_pop / surv_pop 
