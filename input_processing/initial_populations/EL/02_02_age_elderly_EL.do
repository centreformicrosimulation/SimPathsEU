...
*			0. male		1. female	
*  19. Greece			
*    Mean	6.8853653	-2.4454182	
*    SD		5.3504122	4.3059824	
*	Corr	0.51
*------------------------------------------------------------------------
*	Log of age distribution, for 78+ distribution of age is right skewed
*			0. male		1. female
* 19. Greece		
*    Mean	4.4112562	4.3990993
*    SD		0.0461854	0.0392939
...
replace sdlog   = 0.05 if dgn==1 & topcoded78==1
...
*-------------------------------------------------------
scalar mean_diff_male   = 6.9
scalar sd_diff_male     = 5.4
scalar mean_diff_female = -2.4
scalar sd_diff_female   = 4.3
scalar rho_diff         = 0.51
