********************************************************************************
* PROJECT:              ESPON
* DO-FILE NAME:         03_create_benefit_units_EL.do
...
sum child adult // 86% adults 
tab adult child, col

gen partnered = (idpartner > 0) 

tab child partnered // no partnered children 
...
---------------------+--------------------------------------------
Valid   120111904701 |          1       9.09       9.09       9.09
        120111915701 |          1       9.09       9.09      18.18
        120111939301 |          1       9.09       9.09      27.27
        120152940601 |          1       9.09       9.09      36.36
        120195562800 |          1       9.09       9.09      45.45
        120195782901 |          1       9.09       9.09      54.55
        120195815501 |          1       9.09       9.09      63.64
        320217001801 |          1       9.09       9.09      72.73
        420101621201 |          1       9.09       9.09      81.82
        420184544301 |          1       9.09       9.09      90.91
        420184989701 |          1       9.09       9.09     100.00
...
(mother's) home 
*/
replace idhh = 120111904700 if idperson == 12011190470101 & swv == 2010
replace idhh = 120111915700 if idperson == 12011191570101 & swv == 2010
replace idhh = 120111939300 if idperson == 12011193930101 & swv == 2011
replace idhh = 120152940600 if idperson == 12015294060101 & swv == 2013
replace idhh = 120195782900 if idperson == 12019578290101 & swv == 2018
replace idhh = 120195815500 if idperson == 12019581550101 & swv == 2017
replace idhh = 320217001800 if idperson == 32021700180101 & swv == 2021
replace idhh = 420101621200 if idperson == 42010162120101 & swv == 2010
replace idhh = 420184544300 if idperson == 42018454430101 & swv == 2016
replace idhh = 420184989700 if idperson == 42018498970101 & swv == 2018

/* 
One leftover (120195562800), address orphans later. 
*/
...
count if child == 1 & idbenefitunit == . // 513 kids are still not assigned 

cap gen orphan = (idfather < 0 & idmother < 0 & child == 1)
fre orphan if idbenefitunit == . // 513
/*
...
-----------------------------------------------------------
              |      Freq.    Percent      Valid       Cum.
--------------+--------------------------------------------
Valid   0     |     418330      99.60      99.60      99.60
        1     |       1146       0.27       0.27      99.88
        2     |        443       0.11       0.11      99.98
        3     |         71       0.02       0.02     100.00
        5     |         10       0.00       0.00     100.00
        Total |     420000     100.00     100.00           
-----------------------------------------------------------
*/
...
count if child == 1 & idbenefitunit == . & orphan == 1 // 1 orphan obs 
// this individual lives alone and is 17 years old and continues living alone 
...
/* Alternatively could force the eldest to be an adult? */
/*
...
gen orphan_check = 1 if (idfather < 0 & idmother < 0) & ///
	(dag > 0 & dag < $age_become_responsible) // 3 obs 
...
count if dagsp == -9 & idpartner != -9 // 1 obs 
...
count if dehsp_c3 == -9 & idpartner != -9 // 5,110 obs 
...
------------+-----------------------------------
          1 |     30,730        7.32        7.32
          . |    389,269       92.68      100.00
------------+-----------------------------------
      Total |    419,999      100.00
*/
