...
* 					process. 
* 
* 					Run after "reg_home_ownership_PL.do"
********************************************************************************
...
twoway ///
	...
	legend(size(small)) ///
	note("Notes: Predicted vs observed of dummy indicating homeownership. Estimation sample plotted. Sample includes only benefit unit heads. Regression if condition ${ho1_if_condition}", size(vsmall))

graph export "$dir_internal_validation/home_ownership/int_validation_${country}_HO1a_homeownership_hist_all.jpg", ///
...
twoway ///
(line pred_dhh_owned stm, sort color(green) legend(label(1 "Predictions"))) ///
...
title("Home Ownership")  ///
	...
	xlabel(, labsize(small)) ylabel(, labsize(small)) ///
	legend(size(small)) ///
	note("Notes: Estimation sample plotted. Sample includes only benefit unit heads. Regression if condition ${ho1_if_condition}", size(vsmall))

graph export "$dir_internal_validation/home_ownership/int_validation_${country}_HO1a_homeownership_ts_all_both.jpg", ///
	replace width(2560) height(1440) quality(100) 
...
graph export "$dir_internal_validation/home_ownership/int_validation_${country}_HO1a_homeownership_ts_all_gender.jpg", ///
	replace width(2560) height(1440) quality(100)
...
twoway ///
(line pred_dhh_owned dag, sort color(green) legend(label(1 "Predictions"))) ///
...
graph export "$dir_internal_validation/home_ownership/int_validation_${country}_HO1a_homeownership_share_age.jpg", ///
	replace width(2560) height(1440) quality(100)	
...
graph export "$dir_internal_validation/home_ownership/int_validation_${country}_HO1a_homeownership_ts_all_both_income.jpg", ///
	replace width(2560) height(1440) quality(100)
...
collapse (mean) dhh_owned pred_dhh_owned* [aw = dwt], by(deh_c4 stm)
...
replace stm = 2000 + stm 
twoway ///
(line pred_dhh_owned stm if deh_c4 == 0, sort color(green) ///
	legend(label(1 "Pred"))) ///
(line dhh_owned stm if deh_c4 == 0, sort color(green) color(green%20) ///
	lpattern(dash) legend(label(2 "Obs"))), ///
name(graph0) title("In initial education spell") xtitle("Year") ytitle("") ///
	xlabel(, labsize(small)) ylabel(, labsize(small)) ///
	legend(size(small)) ///
	graphregion(color(white))
	
twoway ///
(line pred_dhh_owned stm if deh_c4 == 1, sort color(green) ///
	legend(label(1 "Predictions"))) ///
(line dhh_owned stm if deh_c4 == 1, sort color(green) color(green%20) ///
	lpattern(dash) legend(label(2 "SILC"))), ///
...
twoway ///
(line pred_dhh_owned stm if deh_c4 == 2, sort color(green) ///
	legend(label(1 "Pred"))) ///
(line dhh_owned stm if deh_c4 == 2, sort color(green) color(green%20) ///
	lpattern(dash) legend(label(2 "Obs"))), ///
...
twoway ///
(line pred_dhh_owned stm if deh_c4 == 3, sort color(green) ///
	legend(label(1 "Pred"))) ///
(line dhh_owned stm if deh_c4 == 3, sort color(green) color(green%20) ///
	lpattern(dash) legend(label(2 "Obs"))), ///
...
graph export "$dir_internal_validation/home_ownership/int_validation_${country}_HO1a_homeownership_ts_all_both_edu.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/home_ownership/int_validation_${country}_HO1a_homeownership_ts_all_both_partnership.jpg", ///
	replace width(2560) height(1440) quality(100)
