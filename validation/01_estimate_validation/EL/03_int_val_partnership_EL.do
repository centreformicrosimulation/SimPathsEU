...
* 					process. 
* 
* 					Run after "reg_partnership_EL.do"
********************************************************************************
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1a_partnership_init_edu_hist_all.jpg", ///
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1a_partnership_init_edu_ts_all_both.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1a_partnership_init_edu_ts_all_gender.jpg", ///
	replace width(2560) height(1440) quality(100)	
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1a_partnership_init_edu_share_age.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1a_partnership_init_edu_ts_all_both_income.jpg", ///
	replace width(2560) height(1440) quality(100)	
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1b_partnership_left_edu_hist_all.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1b_partnership_left_edu_ts_all_both.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1b_partnership_left_edu_ts_all_gender.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1b_partnership_left_edu_share_age.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U1b_partnership_left_edu_ts_all_both_income.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U2b_separation_left_edu_hist_all.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U2b_separation_left_edu_ts_all_both.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U2b_separation_left_edu_share_age.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U2b_separation_init_edu_ts_all_both_income.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/partnership/int_validation_${country}_U2b_separation_init_edu_ts_all_both_edu.jpg", ///
	replace width(2560) height(1440) quality(100)
