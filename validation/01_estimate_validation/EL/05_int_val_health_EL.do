...
graph export "$dir_internal_validation/health/int_validation_${country}_H1a_health_init_edu_hist_18_29.jpg", ///
...
graph export "$dir_internal_validation/health/int_validation_${country}_H1a_health_init_edu_ts_18_29_both.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H1a_health_init_edu_ts_18_29_female.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H1a_health_init_edu_ts_18_29_male.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H1a_health_left_edu_hist_all.jpg", ///
	replace	width(2560) height(1440) quality(100)	
...
graph export "$dir_internal_validation/health/int_validation_${country}_H1b_health_left_edu_ts_all_both.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H1b_health_left_edu_ts_all_female.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H1b_health_left_edu_ts_all_male.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H2b_disablilty_left_edu_hist_all.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H2b_disablilty_left_edu_ts_all_both.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H2b_disablilty_left_edu_share_age.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/health/int_validation_${country}_H2b_disablilty_left_edu_ts_all_both_income.jpg", ///
	replace width(2560) height(1440) quality(100)	
...
graph export "$dir_internal_validation/health/int_validation_${country}_H2b_disablilty_left_edu_ts_all_both_edu.jpg", ///
	replace width(2560) height(1440) quality(100)	
...
graph export "$dir_internal_validation/health/int_validation_${country}_H2b_disablilty_left_edu_ts_all_both_partnership.jpg", ///
	replace width(2560) height(1440) quality(100)	
