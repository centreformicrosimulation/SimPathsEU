...
* 					process. 
* 
* 					Run after "reg_leave_parental_home_EL.do"
********************************************************************************
...
graph export "$dir_internal_validation/leave_parental_home/int_validation_${country}_P1a_leave_parental_home_hist_all.jpg", ///
...
graph export "$dir_internal_validation/leave_parental_home/int_validation_${country}_P1a_leave_parental_home_ts_all_both.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/leave_parental_home/int_validation_${country}_P1a_leave_parental_home_ts_all_gender.jpg", ///
	replace width(2560) height(1440) quality(100)	
...
graph export "$dir_internal_validation/leave_parental_home/int_validation_${country}_P1a_leave_parental_home_share_age.jpg", ///
	replace width(2560) height(1440) quality(100)
...
graph export "$dir_internal_validation/leave_parental_home/int_validation_${country}_P1a_leave_parental_home_ts_all_both_income.jpg", ///
	replace width(2560) height(1440) quality(100)
