...
title("Continues in initial education spell") xtitle("Year") ytitle("Share") ///
	...
	legend(size(small)) ///
	note("Notes: Sample contains individuals who are observed in their initial education spelled, aged 16-29.", size(vsmall))


graph export "$dir_internal_validation/education/int_validation_${country}_E1a_continues_edu_ts_year.jpg", ///
