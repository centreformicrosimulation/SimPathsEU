...
forval year = `min_year'/`max_year' {
	...
	twoway (hist sim_yCapitalBuLevelYear if year == `year', width(50) ///
		color(green%30) legend(label(1 "SimPaths"))) ///
	(hist valid_yCapitalBuLevelYear if year == `year', ///
		 width(50) color(red%30) legend(label(2 "SILC"))) , ///
		title("Benefit Unit Capital Income") ///
		subtitle("`year'") ///
...
forval year = `min_year'/`max_year' {
	...
	twoway (hist sim_yCapitalBuLevelYear if year == `year', ///
		width(50) color(green%30) legend(label(1 "SimPaths"))) ///
	(hist valid_yCapitalBuLevelYear if year == `year',  width(50) ///
		...
		legend(size(small)) ///
		graphregion(color(white)) ///
		note("Notes: Amounts in Euro per year, 2015 prices. Top and bottom percentailes trimmed. ", ///
		size(vsmall))
