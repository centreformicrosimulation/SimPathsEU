...
* NOTES: 			This file creates validation targets using simulated data 
* 					generated by do file: 01_prepare_simulated_data.do
********************************************************************************
...
* Partnership status
gen sim_dcpst_p = (dcpst == "Partnered") 
gen sim_dcpst_s = (dcpst == "Single") 
...
foreach var1 in sim_dcpst_p sim_dcpst_s  {
...
replace laboursupplyweekly = "TWENTY" if laboursupplyweekly == "CATEGORY_PL_1"
replace laboursupplyweekly = "FORTY" if laboursupplyweekly == "CATEGORY_PL_2"
replace laboursupplyweekly = "FIFTY" if laboursupplyweekly == "CATEGORY_PL_3"
