...
(line valid_labHrsWorkWeek year, sort color(green) legend(label(2 "SILC"))), ///
...
* Estimate parameters of truncated log normal distribution fit to SILC
use year dwt labC4 valid_labHrsWorkWeek  demAge using ///
	"$dir_data/${country}-eusilc_validation_sample.dta", clear
...
twoway (histogram valid_labHrsWorkWeek, fraction color(ltblue)) ///
    ...
    legend(order(1 "SILC" 2 "Fitted Distribution")) ///
