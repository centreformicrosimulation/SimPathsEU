...
(line p90_p50_ratio_disp_obs year, sort color(green)legend(label(2 "SILC"))), ///
...
twoway (rarea p90_p10_ratio_disp_high p90_p10_ratio_disp_low year, sort ///
	color(green%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
(line p90_p10_ratio_disp_obs year, sort color(green)legend(label(2 "SILC"))), ///
...
twoway (rarea gini_high gini_low year, sort ///
	color(green%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
(line gini year, sort color(green)legend(label(2 "SILC"))), ///
