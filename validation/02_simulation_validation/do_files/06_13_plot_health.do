...
********************************************************************************
********************************************************************************
* 1.1 : Mean values over time, Working age (16-65)
********************************************************************************
...
********************************************************************************
* 1.2 : Mean values over time, Working age (16-65), By gender
********************************************************************************
...
********************************************************************************
* 1.2 : Mean values over time, Working age (16-65), By age group
********************************************************************************
...
foreach vble in "health_f" "health_m" {
	twoway (rarea `vble'_1_sim_high `vble'_1_sim_low year, sort ///
		...
		(line `vble'_1_valid year, sort color(green) legend(label(2 "SILC"))), ///
	...
	twoway (rarea `vble'_2_sim_high `vble'_2_sim_low year, sort ///
		color(green%20) legend(label(1 "Simulated") position(6) rows(1))) ///
		(line `vble'_2_valid year, sort color(green) legend(label(2 "SILC"))), ///
	...
	twoway (rarea `vble'_3_sim_high `vble'_3_sim_low year, sort ///
		color(green%20) legend(label(1 "Simulated") position(6) rows(1))) ///
		(line `vble'_3_valid year, sort color(green) legend(label(2 "SILC"))), ///
	...
	twoway (rarea `vble'_4_sim_high `vble'_4_sim_low year, sort ///
		color(green%20) legend(label(1 "Simulated") position(6) rows(1))) ///
		(line `vble'_4_valid year, sort color(green) legend(label(2 "SILC"))), ///
	...
	twoway (rarea `vble'_5_sim_high `vble'_5_sim_low year, sort ///
		color(green%20) legend(label(1 "Simulated") position(6) rows(1))) ///
		(line `vble'_5_valid year, sort color(green) legend(label(2 "SILC"))), ///
	...
	twoway (rarea `vble'_6_sim_high `vble'_6_sim_low year, sort ///
		color(green%20) legend(label(1 "Simulated") position(6) rows(1))) ///
		(line `vble'_6_valid year, sort color(green) legend(label(2 "SILC"))), ///
	...
	twoway (rarea `vble'_7_sim_high `vble'_7_sim_low year, sort ///
		color(green%20) legend(label(1 "Simulated") position(6) rows(1))) ///
		(line `vble'_7_valid year, sort color(green) legend(label(2 "SILC"))), ///
	...
	/*twoway (rarea `vble'_8_sim_high `vble'_8_sim_low year, sort ///
		color(green%20) legend(label(1 "Simulated") position(6) rows(1))) ///
		(line `vble'_8_valid year, sort color(green) legend(label(2 "SILC"))), ///
...
title("Health score") subtitle("Ages ${min_age}-${max_age}") ///
	xtitle("Health score", size(small)) ///
	ytitle(, size(small)) ///
	xlabel(,labsize(small)) ///
	ylabel(,labsize(small)) ///
	graphregion(color(white)) ///
...
********************************************************************************
* 2.1 : Histograms, Working age, By gender
******************************************************************************** 
...
(hist health if dgn == 1, width(0.2) color(red%30) ///
	legend(label(2 "SILC"))), ///
subtitle("Males") ///
	name(health_male, replace) 	xtitle("Health score", size(small)) ///
	xtitle("", size(small)) ///
	xlabel(,labsize(small)) ///
	ylabel(,labsize(small))  ///
	legend(size(small)) ///
