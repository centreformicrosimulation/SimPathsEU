...
graph bar (mean) valid_yEmpBuGrossLevelYear (mean) valid_yCapitalBuLevelYear ///
	...
	legend(order(1 "Labour" 2 "Capital" 3 "Private Pension") ///
	position(6) rows(1)) ///
	name(SILC_income_comp_all, replace) ///
	b1title("Decile", size(small)) ///
	ytitle("Euro") ///
    ylabel(#5, format(%12.0fc)) ///
	ylabel(,labsize(small)) ///
...
graph bar (mean) valid_yEmpBuGrossLevelYear (mean) valid_yCapitalBuLevelYear ///
	...
	legend(order(1 "Labour" 2 "Capital" 3 "Private Pension") ///
	position(6) rows(1)) ///
	name(SILC_income_comp_upto65, replace) ///
	b1title("Decile", size(small)) ///
	ytitle("Euro") ///
    ylabel(#5, format(%12.0fc)) ///
	ylabel(,labsize(small)) ///
...
graph bar (mean) valid_yEmpBuGrossLevelYear (mean) valid_yCapitalBuLevelYear ///
	...
	legend(order(1 "Labour" 2 "Capital" 3 "Private Pension") ///
	position(6) rows(1)) ///
	name(SILC_income_comp_66plus , replace) ///
	b1title("Decile", size(small)) ///
	ytitle("Euro") ///
    ylabel(#5, format(%12.0fc)) ///
	ylabel(,labsize(small)) ///
...
graph bar (asis) valid_share_emp valid_share_cap valid_share_pen, ///
    ...
    legend(label(1 "Employment") label(2 "Capital") ///
		label(3 "Private Pension")) ///
	name(SILC_income_share_all, replace) ///	
	graphregion(color(white)) 
restore 	
...
graph bar (asis) valid_share_emp valid_share_cap valid_share_pen, ///
    ...
    legend(label(1 "Employment") label(2 "Capital") ///
		label(3 "Private Pension")) ///
	name(SILC_income_share_upto65, replace) ///	
	graphregion(color(white)) 
...
graph bar (asis) valid_share_emp valid_share_cap valid_share_pen, ///
    ...
    legend(label(1 "Employment") label(2 "Capital") ///
		label(3 "Private Pension")) ///
	name(SILC_income_share_66plus, replace) ///	
	graphregion(color(white)) 
...
* Composition  - All
grc1leg simulated_income_comp_all SILC_income_comp_all, ///
	rows(1) ycommon ///
...
grc1leg simulated_income_comp_upto65 SILC_income_comp_upto65, ///
	rows(1) ycommon ///
...
grc1leg simulated_income_comp_66plus SILC_income_comp_66plus, ///
	rows(1) ycommon ///
...
* Shares  - All
grc1leg simulated_income_share_all SILC_income_share_all, ///
	rows(1) ycommon ///
...
* Shares - Working age 
grc1leg simulated_income_share_upto65 SILC_income_share_upto65, ///
	rows(1) ycommon ///
...
grc1leg simulated_income_share_66plus SILC_income_share_66plus, ///
	rows(1) ycommon ///
