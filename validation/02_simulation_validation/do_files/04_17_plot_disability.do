...
use year demAge dwt valid_healthDsblLongtermFlag demMaleFlag demAge ///
	ageGroup using "$dir_data/${country}-eusilc_validation_sample.dta", clear
...
foreach vble in "healthDsblLongtermFlag" {
	...
	(line valid_`vble'_1 year, sort legend(label(2 "SILC"))), ///
		title("Age 15-19") ///
	...
	twoway (rarea sim_`vble'_2_h sim_`vble'_2_l year, ///
		sort color(red%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
		(line valid_`vble'_2 year, sort legend(label(2 "SILC"))), ///
		title("Age 20-24") ///
	...
	twoway (rarea sim_`vble'_3_h sim_`vble'_3_l year, ///
		sort color(red%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
		(line valid_`vble'_3 year, sort legend(label(2 "SILC"))), ///
		title("Age 25-29") ///
	...
	twoway (rarea sim_`vble'_4_h sim_`vble'_4_l year, ///
		sort color(red%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
		(line valid_`vble'_4 year, sort legend(label(2 "SILC"))), ///
		title("Age 30-34") ///
	...
	twoway (rarea sim_`vble'_5_h sim_`vble'_5_l year, ///
		sort color(red%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
		(line valid_`vble'_5 year, sort legend(label(2 "SILC"))), ///
		title("Age 35-39") ///
	...
	twoway (rarea sim_`vble'_6_h sim_`vble'_6_l year, ///
		...
		rows(1))) ///
		(line valid_`vble'_6 year, sort legend(label(2 "SILC"))), ///
		title("Age 40-59") ///
	...
	twoway (rarea sim_`vble'_7_h sim_`vble'_7_l year, ///
		sort color(red%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
		(line valid_`vble'_7 year, sort legend(label(2 "SILC"))), ///
		title("Age 60-79") ///
	...
	twoway (rarea sim_`vble'_8_h sim_`vble'_8_l year, ///
		sort color(red%20) legend(label(1 "SimPaths") position(6) rows(1))) ///
		(line valid_`vble'_8 year, sort legend(label(2 "SILC"))), ///
		title("Age 80-100") ///
