...
use year dwt valid_edu_high valid_edu_med valid_edu_low valid_edu_na ///
	demAge labC4 using "$dir_data/${country}-eusilc_validation_sample.dta", clear
...
* Prepare  validation data
use year dwt valid_edu_high valid_edu_med valid_edu_low valid_edu_na ///
	demAge labC4 demAge using "$dir_data/${country}-eusilc_validation_sample.dta", clear
...
use year idPers dwt valid_edu_high valid_edu_med valid_edu_low labC4 ///
	demAge using "$dir_data/${country}-eusilc_validation_sample.dta", clear
