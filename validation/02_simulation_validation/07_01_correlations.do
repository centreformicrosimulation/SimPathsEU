...
global sim_varlist sim_employed sim_inactive sim_retired sim_edu_high ///
	...
	sim_ypncp_lvl_bu sim_y_disp_yr_bu equivalisedincome ///
	/*obs_earnings_hourly*/ hoursworkedweekly sim_dcpst_s ///
	sim_dcpst_p dhe

global valid_varlist valid_employed valid_inactive valid_retired ///
	valid_edu_high valid_edu_med valid_edu_low valid_y_gross_bu_yr ///
	valid_y_gross_labour_bu_yr valid_y_gross_capital_bu_yr  ///
	valid_y_disp_bu_yr valid_y_eq_disp_bu_yr /*valid_wage_hour*/ valid_lhw ///
	valid_dcpst_s valid_dcpst_p dhe
...
lab var valid_y_disp_bu_yr "Disposable income"
lab var valid_y_gross_bu_yr "Gross income"
lab var valid_y_gross_labour_bu_yr "Gross labour income"
lab var valid_y_gross_capital_bu_yr "Capital income"
//lab var pension_income_bu "Private pension income"
lab var valid_y_eq_disp_bu_yr "Equivalised disposable income"
//lab var valid_wage_hour "Hourly wage"
lab var valid_lhw "Hours worked"
lab var valid_dcpst_p "Partnered"
lab var valid_dcpst_s "Single"
