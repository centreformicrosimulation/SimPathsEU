...
* 					SimPaths model using EU-SILC data for Greece. 
********************************************************************************
clear all
...
global dir_output_files "/Users/ashleyburdett/Documents/ESPON/${country}/validation/graphs" //folder where validations graphs are stored 
...
do "${dir_do_files}/06_04_plot_gross_labour_income.do"å
