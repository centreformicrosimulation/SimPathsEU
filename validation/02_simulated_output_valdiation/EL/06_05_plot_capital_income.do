...
forval year = `min_year'/`max_year' {
	...
	title("Capital income") ///
		...
		graphregion(color(white)) ///
		note("Notes: Individual level observations plotted. All persons ages 18-65. Values in € per year, 2015 prices. X axis range limited to 100." "Top and bottom percentiles trimmed.", ///
		size(vsmall))
