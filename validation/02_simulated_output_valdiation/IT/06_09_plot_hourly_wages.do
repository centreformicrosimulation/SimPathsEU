/*
This do file plots simulated and observed hourly wages of employed individuals
...
title("Hourly wages") xtitle("Year") ytitle("€ per hour") ///
	...
	note("Notes: Statistics calculated on sample of employed anf self-employed individuals. Values in 2015 prices.", size(vsmall))
