/*
This file calculates correlations between variables of interest, in observed and simulated data

List of variables considered. Name : simulated : validation

1. disposable income per benefit unit : sim_y_disp_yr_bu : valid_y_disp_yr_bu 
2. labour market status : sim_employed, sim_student, sim_inactive, sim_retired : valid_employed, valid_student, valid_inactive, valid_retired
...
* Save figure
*graph export "$dir_output_files\validation_correlations_observed_${min_age}_${max_age}.jpg", replace width(2560) height(1440) quality(100)
