...
* LAST UPDATE:		04/2025 (AB)
* COUNTRY: 			Italy 

* NOTES: 			This master do file organises do files used for validating 
* 					SimPaths model using EU-SILC data for Italy. 
********************************************************************************
clear all
...
do "${dir_do_files}/06_13_plot_partnership_status_x_children.do"
do "${dir_do_files}/06_14_plot_health_by_age.do"
do "${dir_do_files}/06_15_plot_activity_status_by_age.do"
do "${dir_do_files}/06_16_plot_at_risk_of_poverty.do"
do "${dir_do_files}/06_17_plot_income_ratios.do"
do "${dir_do_files}/06_19_plot_number_children.do"
do "${dir_do_files}/06_20_plot_disability"
