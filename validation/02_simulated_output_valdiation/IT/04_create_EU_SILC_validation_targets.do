...
use "${dir_data}/${country}-eusilc_validation_sample_prep2.dta", clear 
...
* Females 
replace laboursupplyweekly_hu = "CATEGORY_1" if hours >= 1 & hours <= 29 & ///
	dgn == 0 
replace laboursupplyweekly_hu = "CATEGORY_2" if hours >= 30 & hours <= 35 & ///
	dgn == 0
replace laboursupplyweekly_hu = "CATEGORY_3" if hours >= 36 & hours <= 39 & ///
	dgn == 0 
replace laboursupplyweekly_hu = "CATEGORY_4" if hours >= 40 & hours != . & ///
	dgn == 0 
