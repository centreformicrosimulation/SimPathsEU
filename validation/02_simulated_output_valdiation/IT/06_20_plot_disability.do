/*
This do file plots simulated and observed diability status 
...
(line dlltsd year, sort color(green) ///
	...
	title("Disabled/Long-term sick ") xtitle("") ytitle("Share") ///
	graphregion(color(white)) note("Notes:", size(vsmall)) ///
	legend(size(small)) xlabel(, labsize(small)) ylabel(, labsize(small))
...
(line dlltsd year if dgn == 0, sort color(green) ///
	legend(label(2 "Female observed "))) ///
...
(line dlltsd year if dgn == 1, sort color(red) ///
	legend(label(4 "Male observed"))), ///
title("Disabled/Long-term sick by gender ") xtitle("") ytitle("Share") ///
	graphregion(color(white)) note("Notes:", size(vsmall)) ///
	legend(size(small)) xlabel(, labsize(small)) ylabel(, labsize(small))
