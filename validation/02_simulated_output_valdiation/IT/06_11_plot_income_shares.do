/*
This do file plots simulated and observed income shares and incomes by deciles of gross income

Author: Patryk Bronka
Last modified: October 2023

Altered pension age to 65 
Consider using gross_income_bu_jittered to produce deciles as many bu with 0 
	gross income 
...
grc1leg simulated_income_shares observed_income_shares ///
	...
	note("Notes: Statistics computed at the benefit unit level. Based on values in € per year (2015 prices).", size(vsmall)) 
...
grc1leg simulated_incomes observed_incomes simulated_incomes_o68 ///
	...
	note("Statistics computed at the benefit unit level. Values in € per year (2015 prices).", size(vsmall)) 
...
grc1leg simulated_net_income_shares observed_net_income_shares ///
	...
	note("Statistics computed at the benefit unit level. Based on values in € per year (2015 prices).", size(vsmall)) 
