...
fre idhh if num_adults == 0  // 4 cases 
/*.
------------------------------------------------------------
               |      Freq.    Percent      Valid       Cum.
---------------+--------------------------------------------
Valid   2066   |          1      50.00      50.00      50.00
        237500 |          1      50.00      50.00     100.00
...
count if child == 1 & idbenefitunit == . //703 kids are still not assigned 

cap gen orphan = (idfather < 0 & idmother < 0 & child == 1)
fre orphan if idbenefitunit == . //all 703 
/*
...
-----------------------------------------------------------
              |      Freq.    Percent      Valid       Cum.
--------------+--------------------------------------------
Valid   0     |     258861      99.16      99.16      99.16
        1     |       1543       0.59       0.59      99.75
        2     |        405       0.16       0.16      99.91
        3     |        141       0.05       0.05      99.96
        4     |         79       0.03       0.03      99.99
        5     |         19       0.01       0.01     100.00
        6     |          9       0.00       0.00     100.00
        Total |     261057     100.00     100.00           
-----------------------------------------------------------
*/
