/*
This do file plots simulated and observed at risk of poverty rate
...
(line arop year, sort color(green) legend(label(2 "Observed"))), ///
	...
	note("Note: Poverty line calculated within each year as equivalised disposable income of benefit unit < 60% of the median value.", size(vsmall))

* Save figure
graph export "$dir_output_files/poverty/validation_at_risk_of_poverty_EUSILC_age_${min_age}_${max_age}.jpg", ///
