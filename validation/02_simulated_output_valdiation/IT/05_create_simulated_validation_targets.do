/*
This file creates validation targets using simulated data generated by do file:
	01_prepare_simulated_data.do
...
gen sim_dcpst_snmprvp = (dcpst == "SingleNeverMarried" | dcpst == "PreviouslyPartnered") // single never married & previously partnered
...
* Hours of work
/*
For Italy the discretized groups are different across genders 
For males:
	0 as 0 hours;
	[1, 35] as 30 hours;
	[36, 39] as 36 hours;
...
*/
replace laboursupplyweekly = "" if laboursupplyweekly == "null"

* Males 
gen lhw = .
replace lhw = 0 if laboursupplyweekly == "ZERO" & dgn == "Male"
replace lhw = 30 if laboursupplyweekly == "CATEGORY_1" & dgn == "Male"
replace lhw = 36 if laboursupplyweekly == "CATEGORY_2" & dgn == "Male"
replace lhw = 49 if laboursupplyweekly == "CATEGORY_3" & dgn == "Male"
replace lhw = 50 if laboursupplyweekly == "CATEGORY_4" & dgn == "Male"

* Females 
replace lhw = 0 if laboursupplyweekly == "ZERO" & dgn == "Female"
replace lhw = 20 if laboursupplyweekly == "CATEGORY_1" & dgn == "Female"
replace lhw = 30 if laboursupplyweekly == "CATEGORY_2" & dgn == "Female"
replace lhw = 36 if laboursupplyweekly == "CATEGORY_3" & dgn == "Female"
replace lhw = 40 if laboursupplyweekly == "CATEGORY_4" & dgn == "Female"
...
// Aggregate simulated values to benefit unit level. Note that sim_y_gross_yr and sim_y_disp_yr are already at BU level. 
