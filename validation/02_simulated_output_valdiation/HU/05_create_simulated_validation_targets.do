...
replace lhw = 20 if laboursupplyweekly == "TWENTY" // TWENTY is between 1 and 39 hours
replace lhw = 40 if laboursupplyweekly == "FORTY" // FORTY is between 40 hours
replace lhw = 50 if laboursupplyweekly == "FIFTY" // FIFTY is above 41 hours
