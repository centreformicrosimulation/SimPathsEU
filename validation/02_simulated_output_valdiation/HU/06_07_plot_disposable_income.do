...
* NOTES: 			This do file plots simulated and observed disposable income, 
...
title("Disposable income") xtitle("Year") ytitle("€ per year") ///
	...
	note("Notes: Statistics computed at the benefit unit level. Plotted using individual level data. Sample includes all individuals ages 18-65." "Amounts in 2015 prices. Top and bottom percentials trimmed. ", ///
	size(vsmall))
...
* Prepare validation data
use year dwt valid_y_disp_yr_bu laboursupplyweekly_hu dag  ///
