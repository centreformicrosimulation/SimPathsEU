...
forvalues year = `min_year'/`max_year' {
	...
	grc1leg gross_labour_inc_`year'_all  ///
		...
		graphregion(color(white)) ///
		note("Notes: Amount at the benefit unit level, individual data plotted. Values in € per year, 2015 prices. Weekly hours worked categories:" "ZERO = 0, TWENTY = [1,39], FORTY = 40, FIFTY = 41+. Top and bottom percentiles trimmed.", ///
		size(vsmall)) 
