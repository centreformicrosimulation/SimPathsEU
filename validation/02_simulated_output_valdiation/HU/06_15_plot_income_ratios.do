...
grc1leg p90_p10_ratio_disp p90_p50_ratio_disp, ///
	...
	graphregion(color(white)) ///
	note("Notes: Figures contain household dispoable income decile ratios. Sample contains all individuals ages 18-65. Missing simulated amount due" "to 0 amount for P10 in simulated data.", ///
	size(vsmall))
